...
type UserQuizShare struct {
	...
	UserReferredId string                 `protobuf:"bytes,6,opt,name=user_referred_id,json=userReferredId,proto3" json:"user_referred_id,omitempty"`
	UserSharedId   string                 `protobuf:"bytes,7,opt,name=user_shared_id,json=userSharedId,proto3" json:"user_shared_id,omitempty"`
...
func (x *UserQuizShare) GetUserReferredId() string {
	if x != nil {
		return x.UserReferredId
	}
	return ""
}

func (x *UserQuizShare) GetUserSharedId() string {
	if x != nil {
...
var file_publicit_domain_user_quizzes_user_quiz_share_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x2f, 0x71, 0x75, 0x69, 0x7a, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x91, 0x03,
	...
	0x12, 0x28, 0x0a, 0x10, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x72, 0x65, 0x66, 0x65, 0x72, 0x72, 0x65,
	0x64, 0x5f, 0x69, 0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x75, 0x73, 0x65, 0x72,
	0x52, 0x65, 0x66, 0x65, 0x72, 0x72, 0x65, 0x64, 0x49, 0x64, 0x12, 0x24, 0x0a, 0x0e, 0x75, 0x73,
	0x65, 0x72, 0x5f, 0x73, 0x68, 0x61, 0x72, 0x65, 0x64, 0x5f, 0x69, 0x64, 0x18, 0x07, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x0c, 0x75, 0x73, 0x65, 0x72, 0x53, 0x68, 0x61, 0x72, 0x65, 0x64, 0x49, 0x64,
