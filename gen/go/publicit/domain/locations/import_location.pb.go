...
type ImportLocation struct {
	...
	ProcessedRowCount int64                  `protobuf:"varint,7,opt,name=processed_row_count,json=processedRowCount,proto3" json:"processed_row_count,omitempty"`
	TotalRowCount     int64                  `protobuf:"varint,8,opt,name=total_row_count,json=totalRowCount,proto3" json:"total_row_count,omitempty"`
}
...
func (x *ImportLocation) GetProcessedRowCount() int64 {
	if x != nil {
...
func (x *ImportLocation) GetTotalRowCount() int64 {
	if x != nil {
...
var file_publicit_domain_locations_import_location_proto_rawDesc = []byte{
	...
	0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x07, 0x20, 0x01, 0x28, 0x03, 0x52, 0x11, 0x70, 0x72,
	...
	0x6e, 0x74, 0x18, 0x08, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0d, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x52,
